...
function pilotGate(env,booking) {
  // Optional trial gate: when BOOKING_ALLOWED_EMAIL is set, only that address
  // may submit. Unset means bookings are open to the public.
  const allowed=env.BOOKING_ALLOWED_EMAIL;
  if(typeof allowed!=='string'||!allowed.trim())return;
