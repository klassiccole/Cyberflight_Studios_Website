...
import {addDays} from './booking-input.mjs';
...
async function createBookingEvent(env,booking,id) {
  try {
    ...
    const eventEndDef=isAllDay?{date:C.addDays(booking.date,1)}:{dateTime:new Date((booking.sessionEnd+1800)*1000).toISOString(),timeZone:ZONE};
